              ...
              <div className={styles.sommaireAvatarTitre}>
                    ...
                    <img
                      src={
                        ...
                        '/mediafiles/avatars/default.png'
                          ? `https://ui-avatars.com/api/?name=${donnees?.author?.fullname}`
                          : `${donnees?.author?.avatar}`
                      }
                      alt='user-avatar'
                ...
                <div className=''>
                  ...
                  <div className={styles.forumSommairAauteurCard}>
                    ...
                    {donnees?.author?.prenom !== undefined ||
                    donnees?.author?.nom !== undefined
                      ? donnees?.author?.prenom + ' ' + donnees?.author?.nom
                      : 'Anonyme'}
                  </div>
                </div>
              </div>
