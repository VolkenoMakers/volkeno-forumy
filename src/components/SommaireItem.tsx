        ...
        Datas.map((item: any) => {
          return (
            <NavLink
              ...
              key={item.id}
            >
              <div className={styles.forumCardSommaire} key={item?.id}>
                      ...
                      <img
                        src={
                          ...
                          '/mediafiles/avatars/default.png'
                            ? `https://ui-avatars.com/api/?name=${item?.author?.firstName} + ${item?.author?.lastName}`
                            : `${item?.author?.avatar}`
                        }
                        alt='user-avatar'
                ...
                <div className='row'>
                  ...
                  <div className='col-lg-3'>
                    <div className={styles.sommaireForumUserChat}>
                      {item?.user_comments?.slice(0, 4).map((comment: any) => (
                        <img
                          src={
                            comment?.user?.avatar ===
                            '/mediafiles/avatars/default.png'
                      ...
                      <div className={styles.divSommaireForumUserChat5}>
                        <div className={styles.troisPoints}>
                          {`
                                    ${
                                      item?.user_comments?.length > 4
                                        ? item?.user_comments?.length - 4 + '+'
                                        : '...'
                                    }
                                `}
          ...
          <div className='row div-card'>
            ...
            >
              ...
              <p>
                ...
                <span className={`${styles.emptySubjectMessageBtnPlus}`}>
                  +
                </span>{' '}
