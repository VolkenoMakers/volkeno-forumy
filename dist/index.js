...
function Discussion() {
  ...
  return React__default.createElement("div", {
    ...
    className: styles.textSommaireForum
  }, DatasForum === null || DatasForum === void 0 ? void 0 : DatasForum[0].contenu)))), React__default.createElement(FrontCommentItem, null), React__default.createElement("div", {
...
var VolkenoForumy = function VolkenoForumy() {
  return React.createElement(reactRouterDom.BrowserRouter, null, React.createElement("div", {
    ...
    path: '/ajouter-sujet',
    element: React.createElement(Ajoutersujet, null)
  }))));
};
