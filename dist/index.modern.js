...
const FrontCommentItem = ({
  ...
  }, DataInt === null || DataInt === void 0 ? void 0 : (_DataInt$first_level_ = DataInt.first_level_response) === null || _DataInt$first_level_ === void 0 ? void 0 : _DataInt$first_level_.map(donnee => {
...
const SommaireItem = ({
  ...
  }, "No talking point"), React__default.createElement("p", null, "Press on the ", React__default.createElement("span", {
    className: `${styles.emptySubjectMessageBtnPlus}`
  }, "+"), " button at the bottom to add subject. ")))));
};
...
const VolkenoForumy = ({ ...props
  ...
  }, createElement(BrowserRouter, null, createElement(Routes, null, createElement(Route, {
    path: "/",
